...
<body>
    ...
    <div class="container">
        <div class="card text-center">
            ...
            <form action="<?php echo e(route('admin.anggota.store')); ?>" method="POST" class="text-start">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\laragon\www\sistemkoperasi\resources\views/admin/anggota/create.blade.php ENDPATH**/ ?>