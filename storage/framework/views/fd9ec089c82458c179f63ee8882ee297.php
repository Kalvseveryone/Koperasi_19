        ...
        <div class="card shadow rounded-4">
            ...
            <div class="card-body">
                <ul class="list-group list-group-flush mb-4">
                    <li class="list-group-item"><strong>ID:</strong> <?php echo e($anggota->id); ?></li>
                    <li class="list-group-item"><strong>Nama:</strong> <?php echo e($anggota->nama); ?></li>
                    <li class="list-group-item"><strong>Email:</strong> <?php echo e($anggota->email); ?></li>
                    <li class="list-group-item"><strong>Alamat:</strong> <?php echo e($anggota->alamat); ?></li>
                    <li class="list-group-item"><strong>Saldo Simpanan:</strong> Rp<?php echo e(number_format($anggota->saldo_simpanan, 0, ',', '.')); ?></li>
                </ul>

                <div class="d-flex justify-content-between">
                    <a href="<?php echo e(route('admin.anggota.edit', $anggota->id)); ?>" class="btn btn-warning">
                        <i class="fas fa-edit"></i> Edit
                    </a>

                    <form action="<?php echo e(route('admin.anggota.destroy', $anggota->id)); ?>" method="POST" onsubmit="return confirm('Yakin ingin menghapus anggota ini?')">
                        <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\sistemkoperasi\resources\views/admin/anggota/show.blade.php ENDPATH**/ ?>