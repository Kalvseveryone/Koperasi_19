...
<body>
    ...
    <div class="center-wrapper">
        <div class="form-container">
            ...
            <form action="<?php echo e(route('admin.kolektor.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\laragon\www\sistemkoperasi\resources\views/admin/kolektor/create.blade.php ENDPATH**/ ?>